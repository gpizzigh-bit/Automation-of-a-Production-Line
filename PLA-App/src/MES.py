...
if __name__ == '__main__':
    ...
    try:
        ...
        var = client.get_node("ns=4;s=|var|CODESYS Control Win V3 x64.Application.TimeMeas.Tempo")
        timein = var.get_value()

        var = client.get_node("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Geral.WH_out.cmd_R")
        var.set_value(True)

        var2 = client.get_node("ns=4;s=|var|CODESYS Control Win V3 x64.Application.TimeMeas.test")
        var2.set_value(2)
        ...
        var = client.get_node("ns=4;s=|var|CODESYS Control Win V3 x64.Application.TimeMeas.Tempo")
        timeout = var.get_value()

        diftime = timeout-timein
